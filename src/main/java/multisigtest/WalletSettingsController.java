...
import static multisigtest.utils.WTUtils.didThrow;
import static multisigtest.utils.WTUtils.unchecked;
...
public class WalletSettingsController {
    ...
    public void restoreClicked(ActionEvent event) {
        ...
        if (Main.bitcoin.wallet().getBalance().value > 0) {
            GuiUtils.informationalAlert("Wallet is not empty",
        ...
        if (aesKey != null) {
            ...
            GuiUtils.informationalAlert("Wallet is encrypted",
        ...
        GuiUtils.informationalAlert("Wallet restore in progress",
    ...
    public void passwordButtonClicked(ActionEvent event) {
        if (aesKey == null) {
            ...
            GuiUtils.informationalAlert("Wallet decrypted", "A password will no longer be required to send money or edit settings.");
